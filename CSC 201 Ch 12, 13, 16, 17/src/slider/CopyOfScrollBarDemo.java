...
public class CopyOfScrollBarDemo extends JFrame{
	...
	public static JScrollBar redSlider = new JScrollBar(JScrollBar.HORIZONTAL);
	public static JScrollBar greenSlider = new JScrollBar(JScrollBar.HORIZONTAL);
	public static JScrollBar blueSlider  = new JScrollBar(JScrollBar.HORIZONTAL);
	public CopyOfScrollBarDemo()
	{
	...
	{
		CopyOfListener listen = new CopyOfListener();//makes listener
		redSlider.addAdjustmentListener(listen);//adds listeners
		greenSlider.addAdjustmentListener(listen);
		blueSlider.addAdjustmentListener(listen);
		//sets title to panel
		panel.setBorder(new CompoundBorder(new TitledBorder("Choose colors"),
				new EmptyBorder(2, 2, 2, 2)));
